...
public:
    ...
    Uni_var(unsigned char d, unsigned char mNum){
        dmo = d-1;
        m = mNum;
        coeffs = vector<unsigned char>();
        expns = vector<unsigned char>();
    }; 
...
public:
    ...
    D_var(unsigned char dim, unsigned char mNum){
        ...
        m = mNum;
        t = calcLT(M, d);
        expns = vector<vector<unsigned char> > ();
        coeffs = vector<unsigned char> ();
    }; 
    vector<unsigned char> getCoeffs() {   
        return coeffs;
...
vector<unsigned char> remove (vector<unsigned char> lst, int j){
    vector<unsigned char> n = vector<unsigned char>();
